        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute inset-8 sm:inset-12 md:inset-15 lg:inset-25">
            ...
            <div className="flex gap-4 sm:gap-5">
              <button className=" bg-primary text-white text-[14px] sm:text-lg font-semibold px-5.5 py-5 rounded-sm">
                Discover More
              </button>
              <button className=" bg-transparent ring-2 ring-white text-white text-[14px] sm:text-lg font-semibold p-5.5 py-5 rounded-sm">
                Latest Project
              </button>
            </div>
