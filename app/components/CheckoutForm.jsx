...
const CheckoutForm = ({ serviceDetails }) => {
  ...
  return (
    <div>
      <h2 className=" mt-15 md:mt-25 lg:mt-32.5 font-semibold text-light-dark text-2xl">{serviceDetails.title}</h2>
      <p className="text-lg text-light-dark">Price: ${serviceDetails.price}</p>
      <form
